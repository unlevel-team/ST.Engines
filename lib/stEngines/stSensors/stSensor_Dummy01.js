...
class STSensor_Dummy01 extends SensorEngine {
	 ...
	 * Start engine
	 * 
	 * @fires SensorEngine#Engine_Start
	 * 
	 */
	startEngine() {
		...
		stSensor.eventEmitter.emit( stSensor.CONSTANTS.Events.Engine_Start );
	}
	 ...
	 * Stop engine
	 * 
	 * @fires SensorEngine#Engine_Stop
	 * 
	 */
	stopEngine() {
		...
		// for MainLoop_Stop
		stSensor.eventEmitter.emit( stSensor.CONSTANTS.Events.Engine_Stop );
